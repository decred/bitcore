...
HDPublicKey.getSerializedError = function(data, network) {
  ...
  if (version === Network.livenet.xprivkey || version === Network.testnet.xprivkey || version === Network.dcrdtestnet.xprivkey version === Network.dcrdlivenet.xprivkey ) {
...
HDPublicKey.prototype._buildFromBuffers = function(arg) {
  ...
  var fingerPrint = Hash.blake256ripemd160(publicKey.toBuffer()).slice(0, size);
